// based upon : https://github.com/kresCruz/angular-materialize

(function (angular) {
    angular.module("ui.materialize", ["ui.materialize.toast", "ui.materialize.sidenav", "ui.materialize.material_select", "ui.materialize.dropdown", "ui.materialize.inputfield", "ui.materialize.tabs", "ui.materialize.collapsible"]);
    ...
    angular.module("ui.materialize.toast", [])
        ...
        .directive("modal-trigger", [function () {
            return {
                link: function (scope, element, attrs) {

                    element.bind(attrs.modal, function () {
                        element.openModal();
                    });
                }
            };
  ...
  $(document).ready(function(){
    ...
    angular.module("ui.materialize.dropdown", [])
     ...
     angular.module("ui.materialize.collapsible", [])
        .directive("collapsible", ["$compile", "$timeout", function ($compile, $timeout) {
